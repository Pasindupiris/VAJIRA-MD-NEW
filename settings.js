...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'PASINDU' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '0768600285' : process.env.OWNER_NUMBER,   
